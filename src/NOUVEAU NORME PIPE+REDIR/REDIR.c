...
static int handle_out_redir(t_cmd *cmd, int *i, char **new_args);
static int handle_heredoc_redir(t_cmd *cmd, int *i, char **new_args);
static int handle_in_redir(t_cmd *cmd, int *i, char **new_args);
